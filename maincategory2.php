  ...
  <body>
    <section>
      ...
      <?php
         ...
         $q3 = "SELECT COUNT(*) as cnt FROM fictiondata WHERE fiction_genre='$realsub' AND fiction_pricecategory='유료' ";
         ...
         if(is_numeric($page)==false||$page<0||$page>$total_page&&$total_page!=0){
           echo '<script>alert("잘못된 접근입니다.");document.location.href="./main.html?categoryid=2";</script>';
         }
         ...
         function myListener(obj) {
           if(obj.value=="1"){
              location.href="main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid ?>&sort=1";
           }else if(obj.value=="2"){
              location.href="main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid ?>&sort=2";
           }else if(obj.value=="3"){
              location.href="main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid ?>&sort=3";
           }
         }
         </script>
         <?php
         if($sort==="1"){
           $q = "SELECT * FROM fictiondata WHERE fiction_genre='$realsub' AND fiction_pricecategory='유료' order by fiction_count desc limit $limit_start,$onepage";
         }elseif($sort==="2"){
           $q = "SELECT * FROM fictiondata WHERE fiction_genre='$realsub' AND fiction_pricecategory='유료' order by fiction_favorite desc limit $limit_start,$onepage";
         }elseif($sort==="3"){
           $q = "SELECT * FROM fictiondata WHERE fiction_genre='$realsub' AND fiction_pricecategory='유료' order by fiction_newdate desc limit $limit_start,$onepage";
    ...
    <div class="" id="page">
     <!-- 처음 버튼 -->
      ...
      ?>
           <a href="./main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid; ?>&sort=<?php echo $sort ?>&page=1">처음</a>
      ...
      ?>
           <a href="./main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid; ?>&sort=<?php echo $sort ?>&page=<?php echo $prev_block; ?>">이전</a>
      ...
      ?>
             <a href="./main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid; ?>&sort=<?php echo $sort ?>&page=<?php echo $i; ?>">[<?php echo $i; ?>]</a>
      <?php
           }
         }
      ?>
     <!-- 다음 버튼 -->
      <?php if($block >= $total_block){
        ...
        $next_block=$block_end +1;
         ?>
         <a href="./main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid; ?>&sort=<?php echo $sort ?>&page=<?php echo $next_block; ?>">다음</a>
       <?php } ?>
      <!-- 마지막 버튼 -->
      <?php if($page>=$total_page){ ?>
        <span>마지막</span>
     <?php }else{ ?>
        <a href="./main.html?categoryid=2&subcategoryid=<?php echo $dfsubcategoryid; ?>&sort=<?php echo $sort ?>&page=<?php echo $total_page; ?>">마지막</a>
     <?php } ?>
    </div>
    <!--페이징 끝-->
