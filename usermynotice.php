      ...
      if (empty($dfsubnoticecategory)===false) {
          ...
          <div class="noticeread_container">
            <div class="noticereadgrid">
              ...
              <div class="noticeread_description">
               <p style="word-break:break-all;text-align:left;padding-top:20px;padding-left:10px;padding-right:10px;"><?php echo $description; ?></p>
              </div>
            </div>
          </div>
          ...
          <div class="comment_containerout">
           ...
           <div class="comment_container">
             ...
             <?php
             $q2 = "SELECT * FROM commentdata WHERE postdataid='$idpostdata' order by idcommentdata asc";
           ...
           <div class="commentwrite_container">
             <form class="" name="commentregisterfrm" action="commentregister_ok.php" method="post">
               ...
               <textarea name="commentdescription" rows="8" cols="80" style="width:750px;"></textarea>
               <?php if(empty($_SESSION['usernickname'])){ ?>
        ...
        <table class="list-table">
          <thead>
            ...
            <?php
              ...
              $q3 = "SELECT COUNT(*) as cnt FROM postdata WHERE author='$dfusernickname' order by idpostdata desc";
              ...
              $q = "SELECT * FROM postdata WHERE author='$dfusernickname' order by idpostdata  desc limit $limit_start,$onepage";
              ...
              <td width="500"><a id="readcount_<?php echo $board['idpostdata']; ?>" style="cursor:pointer" ><?php echo $title;?> +<?php echo $board['commentcount']; ?></a></td>
               ...
               <script type="text/javascript">
                    ...
                    $.ajax({
                     ...
                     location.href="./main.html?categoryid=3&subnoticecategory=<?php echo $idpostdata; ?>";
...
<?php if(!empty($allpost)){ ?>
          <div class="" id="page">
           <!-- 처음 버튼 -->
            ...
            ?>
                 <a href="./userpage.html?usercategoryid=5&page=1">처음</a>
            ...
            ?>
                 <a href="./userpage.html?usercategoryid=5&page=<?php echo $prev_block; ?>">이전</a>
            ...
            ?>
                   <a href="./userpage.html?usercategoryid=5&page=<?php echo $i; ?>">[<?php echo $i; ?>]</a>
            <?php
                 }
               }
            ?>
           <!-- 다음 버튼 -->
            <?php if($block >= $total_block){
              ...
              $next_block=$block_end +1;
               ?>
               <a href="./userpage.html?usercategoryid=5&page=<?php echo $next_block; ?>">다음</a>
             <?php } ?>
            <!-- 마지막 버튼 -->
            <?php if($page>=$total_page){ ?>
              <span>마지막</span>
           <?php }else{ ?>
              <a href="./userpage.html?usercategoryid=5&page=<?php echo $total_page; ?>">마지막</a>
           <?php } ?>
          </div>
<?php }else{} ?>
           ...
           <div id="write_area">
                 ...
                 <div class="in_category">
                   ...
                   <div class="in_descriptiontext">
                     <pre style="float:right">내용(100자 이상)</pre>
                   </div>
...
<div class="board_write">
          ...
          <div id="write_area">
                ...
                <div class="in_category">
                  ...
                  <div class="in_description">
                      <textarea name="description" id="udescription" style="width:100%;min-height:300px;height:auto" required><?php echo $description; ?></textarea>
                  </div>
